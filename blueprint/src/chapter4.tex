...
\begin{definition}[convergent (LMM) (402A)]
...
\begin{definition}[consistent (LMM) (404B)]

  \label{def:404B}
  \lean{Butcher.Ch4.Def404B}
  \uses{def:404A, thm:306A}
...
\begin{theorem}[Order Condition for Linear Multistep Methods (410B) (410B)]
...
\begin{theorem}[Order Condition for Linear Multistep Methods (410D) (410D)]
...
\begin{theorem}[The underlying one-step method (LMM) (422A)]
...
\begin{theorem}[Order arrows for linear multistep methods (443A)]
  ...
  \uses{def:442A, thm:355B, thm:355C, thm:355D, thm:355E, thm:355F, thm:355G}
