...
quantitative convergence chains. The cycle 394–402 `truncationOp` bridge
and the cycle 405 Grönwall wrapper remain the reusable infrastructure.
The next §1.2 convergence frontier is a small generic Adams–Bashforth
`s`-step convergence abstraction that factors the repeated AB2–AB6 scalar
and vector patterns.
