...
\begin{theorem}[302C]
  ...
  \uses{def:310A, thm:302A, thm:302B}
...
\begin{theorem}[311B]
  ...
  \uses{def:310A, lem:310B, lem:311A}
...
\begin{theorem}[311D]
  ...
  \uses{def:310A, lem:310B, thm:311C}
...
\begin{theorem}[315A]
  ...
  \uses{def:310A, thm:311C, thm:311D, thm:313B}
...
\begin{theorem}[317A]
  ...
  \uses{def:310A, def:312A, thm:315A}
...
\begin{theorem}[319B]
  ...
  \uses{def:110A, def:406A, lem:319A}
...
\begin{theorem}[323B]
  ...
  \uses{def:312A, def:323A, lem:322A}
Let
\[
\begin{array}{ccc}
 & c & A \\
...
\begin{theorem}[324B]
  ...
  \uses{def:312A, thm:315A, thm:317A, thm:324A}
...
\begin{theorem}[324C]
  ...
  \uses{def:310A, thm:315A, thm:317A, thm:324A, thm:324B}
...
\begin{theorem}[342C]
  ...
  \uses{def:388D, def:388F, lem:342A, lem:342B}
\begin{gather}
...
\begin{corollary}[342D]

  \label{cor:342D}
  \lean{Butcher.Ch3.Cor342D}
  \uses{def:312A, lem:342A, lem:342B, thm:342C}
...
\begin{theorem}[343B]
  ...
  \uses{cor:342D, def:312A, def:323A, lem:342A, lem:342B, thm:342C, thm:343A}
...
\section{Stability of Implicit Runge–Kutta Methods}
  ...
  \uses{def:520C, def:520E, def:542A}
...
\begin{lemma}[351A]
  ...
  \uses{def:350A, def:356A, def:520C, def:542A}
...
\begin{theorem}[351B]
  ...
  \uses{def:350A, def:520C, def:520E, def:542A, lem:351A}
...
\begin{theorem}[352E]
  ...
  \uses{thm:352A, thm:352C, thm:352D}
...
\begin{theorem}[355F]
  ...
  \uses{def:355A, def:520C, def:520E, def:542A, thm:351B}
...
\begin{theorem}[355G]
  ...
  \uses{def:355A, def:520C, def:520E, def:542A, thm:355E, thm:355F}
...
\begin{definition}[356B]

  \label{def:356B}
  \lean{Butcher.Ch3.Def356B}
  \uses{cor:356D, thm:356C}
...
\begin{corollary}[356D]

  \label{cor:356D}
  \lean{Butcher.Ch3.Cor356D}
  \uses{def:381E, thm:356C}
...
\begin{theorem}[357D]
  ...
  \uses{def:356A, def:357A, def:381E, thm:357C}
...
\begin{lemma}[359A]
  ...
  \uses{cor:342D, def:312A, lem:342A, lem:342B, thm:342C}
Let
\[
X_G = W BAW,
\]
...
\begin{corollary}[359B]

  \label{cor:359B}
  \lean{Butcher.Ch3.Cor359B}
  \uses{def:312A, def:357B, lem:359A}
...
\begin{definition}[370A]

  \label{def:370A}
  \lean{Butcher.Ch3.Def370A}
  \uses{def:312A, def:357B}
...
\begin{theorem}[372A]
  ...
  \uses{def:310A, def:370A, thm:304A, thm:315A}
...
\begin{definition}[381A]

  \label{def:381A}
  \lean{Butcher.Ch3.Def381A}
  \uses{def:110A, thm:381H}
...
\begin{definition}[381B]

  \label{def:381B}
  \lean{Butcher.Ch3.Def381B}
  \uses{def:381C, def:381D, def:381E, def:381F, thm:381H}
...
\begin{definition}[381F]

  \label{def:381F}
  \lean{Butcher.Ch3.Def381F}
  \uses{def:381D, def:381E}
...
\begin{theorem}[381G]
  ...
  \uses{def:310A, def:312A, def:381E}
...
\begin{theorem}[381H]
  ...
  \uses{def:381C, def:381D, def:381E, def:381F, thm:381G}
...
\begin{theorem}[382B]
  ...
  \uses{def:381A, def:381D, thm:382A}
...
\begin{theorem}[387A]
  ...
  \uses{def:310A, lem:383D, thm:311C}
...
\begin{theorem}[388A]
  ...
  \uses{def:388D, def:388F, thm:388C}
...
\begin{theorem}[388B]
  ...
  \uses{def:388D, def:388F, lem:383A, lem:383B, lem:383C, lem:383D, thm:386A, thm:387A, thm:388C, thm:388E, thm:388G}
...
\begin{definition}[388D]

  \label{def:388D}
  \lean{Butcher.Ch3.Def388D}
  \uses{def:381B, def:388F}
...
\begin{lemma}[389A]
  ...
  \uses{def:388D, def:388F, thm:388A, thm:388B, thm:388C, thm:388E, thm:388G, thm:388H}
