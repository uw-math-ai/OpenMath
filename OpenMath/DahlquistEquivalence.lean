...
4. `uniformly_bounded_tupleSucc_iterates`: spectral bound via `OpenMath.SpectralBound`.
...
/-- **Spectral bound**: Under zero-stability, the companion operator `tupleSucc`
  ...
  (since unit-circle roots of ρ are simple), so `OpenMath.SpectralBound`
  applies directly. -/
...
/-- Adams–Moulton 3-step is convergent. -/
theorem adamsMoulton3_convergent : adamsMoulton3.IsConvergent :=
  (dahlquist_equivalence adamsMoulton3).mpr
    ⟨adamsMoulton3_consistent, adamsMoulton3_zeroStable⟩

/-- Adams–Bashforth 4-step is convergent. -/
theorem adamsBashforth4_convergent : adamsBashforth4.IsConvergent :=
  (dahlquist_equivalence adamsBashforth4).mpr
    ⟨adamsBashforth4_consistent, adamsBashforth4_zeroStable⟩

/-- Adams–Moulton 4-step is convergent. -/
theorem adamsMoulton4_convergent : adamsMoulton4.IsConvergent :=
  (dahlquist_equivalence adamsMoulton4).mpr
    ⟨adamsMoulton4_consistent, adamsMoulton4_zeroStable⟩

/-- Adams–Bashforth 5-step is convergent. -/
theorem adamsBashforth5_convergent : adamsBashforth5.IsConvergent :=
  (dahlquist_equivalence adamsBashforth5).mpr
    ⟨adamsBashforth5_consistent, adamsBashforth5_zeroStable⟩

/-- Adams–Bashforth 6-step is convergent. -/
theorem adamsBashforth6_convergent : adamsBashforth6.IsConvergent :=
  (dahlquist_equivalence adamsBashforth6).mpr
    ⟨adamsBashforth6_consistent, adamsBashforth6_zeroStable⟩

/-- Adams–Moulton 5-step is convergent. -/
theorem adamsMoulton5_convergent : adamsMoulton5.IsConvergent :=
