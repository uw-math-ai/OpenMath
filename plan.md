...
quantitative chains, and cycle 438 closed the AM2 vector chain
(`OpenMath/LMMAM2VectorConvergence.lean`) by porting the AM2 scalar
template against the now-public AB3 vector fourth-order Taylor helpers.
The next §1.2 convergence frontier is the **AM3 vector** quantitative
chain (using to-be-promoted AB4 fourth/fifth-order vector Taylor
helpers from `LMMAB4Convergence`), as the natural cycle-439 target.
