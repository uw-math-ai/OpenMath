...
hosts the Adams–Moulton 7-step vector quantitative convergence chain, and
...
vector quantitative convergence chains. Cycle 445 adds
`OpenMath/LMMAM7VectorConvergence.lean`, with private ninth-order vector
Taylor helpers and the AM7 residual coefficient `84361887977/348364800 ≈
242.17` slackened to `243`, at growth `10L`. The next §1.2 convergence
frontier is **BDF1–BDF6 quantitative convergence**, with AB7/AM8 as the next
