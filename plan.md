...
quantitative convergence chains. AM2–AM6 now each have closed scalar and
vector quantitative convergence chains. Cycle 443 adds
`OpenMath/LMMAM6VectorConvergence.lean`, with private eighth-order vector
Taylor helpers and the AM6 residual coefficient `1121952791/12700800`
slackened to `89`, mirroring the scalar AM6 chain at growth `7L`.
The next §1.2 convergence frontier is the **AM7 scalar/vector** chain.
