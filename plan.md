...
quantitative convergence chain, and
...
vector quantitative convergence chains. Cycle 444 adds
`OpenMath/LMMAM7Convergence.lean`, with private ninth-order Taylor helpers
and the AM7 residual coefficient `84361887977/348364800 ≈ 242.17`
slackened to `243`, at growth `10L` (minimum integer `G ≥ 2(β + S) ≈ 9.33`).
The next §1.2 convergence frontier is the **AM7 vector** chain.
