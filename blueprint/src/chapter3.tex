...
\begin{lemma}[The Taylor expansion of the exact solution (311A)]
  ...
  \uses{def:310A, lem:310B, thm:311B}
...
\begin{lemma}[Global truncation error (RK) (319A)]
...
\begin{theorem}[Padé approximations to the exponential function (352A)]

  \label{thm:352A}
  \lean{Butcher.Ch3.Thm352A}
  \uses{thm:352C, thm:352D, thm:352E}
...
\begin{theorem}[A-stability Pade approximation order restriction (355G)]
  ...
  \uses{def:355A, thm:355E, thm:355F}
...
\begin{definition}[reduced method (356B) (356B)]
...
\begin{theorem}[BN Stability Implies AN Stability (357D)]
  ...
  \uses{def:356A, def:356B, def:357A, def:357B}
...
\begin{corollary}[W transformation preserves orthogonality conditions (359B)]
  ...
  \uses{cor:342D, def:357B, lem:359A, thm:342C}
...
\begin{theorem}[Singly implicit methods (363A)]
  ...
  \uses{cor:342D, cor:359B, lem:342A, lem:342B, lem:359A, thm:342C}
...
\begin{theorem}[Order conditions (372A)]
  ...
  \uses{def:370A, thm:301A, thm:315A}
...
\begin{definition}[equivalent (381A)]
  ...
  \uses{def:110A, def:381B, def:381C, def:381D, def:381E, def:381F, thm:381H}
...
\begin{definition}[0-reduced method (381C)]
  ...
  \uses{def:381B, def:381D, def:381E}
...
\begin{definition}[reduced method (381E) (381E)]
...
\begin{theorem}[Runge Kutta method composition inverse (382B)]
  ...
  \uses{def:381A, lem:383D, thm:382A}
...
\begin{lemma}[Runge Kutta group inverse formula (383D)]
  ...
  \uses{lem:383A, lem:383B, lem:383C}
\label{lem:383D}
