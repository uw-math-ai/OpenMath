...
\begin{definition}[consistent (GLM) (510B)]

  \label{def:510B}
  \lean{Butcher.Ch5.Def510B}
  \uses{def:142A, def:510A, def:510C}
...
\begin{definition}[convergent (GLM) (512A)]

  \label{def:512A}
  \lean{Butcher.Ch5.Def512A}
  \uses{def:110A, def:510A, def:510B, def:510C}
...
```latex
\begin{lemma}[Stability and consistency imply convergence (515A) (515A)]
...
\begin{lemma}[Stability and Consistency Imply Convergence (515B) (515B)]
...
\begin{theorem}[Stability and Consistency Imply Convergence (515D) (515D)]

  \label{thm:515D}
  \lean{Butcher.Ch5.Thm515D}
  \uses{def:510A, def:510B, def:510C, def:512A}
...
\begin{definition}[A-stable (520E)]
  ...
  \uses{def:142A, def:520C, thm:520D}
...
\begin{definition}[Order relative to starting method (530B) (530B)]
...
\begin{definition}[Order relative to starting method (530C) (530C)]
...
\begin{theorem}[The underlying one-step method (GLM) (535A)]

  \label{thm:535A}
  \lean{Butcher.Ch5.Thm535A}
  \uses{def:422B, def:510A, def:510B, def:510C, thm:422A}
...
\begin{definition}[annihilation conditions (542A)]
  ...
  \uses{def:310A, def:510A, def:510B, def:510C, def:512A, def:520C, thm:520B}
...
\begin{theorem}[Single Non Zero Eigenvalue Stability (551B)]
  ...
  \uses{def:520A, def:551A, thm:550B}
...
\begin{theorem}[Derivation of methods with IRK stability (553A)]
  ...
  \uses{def:551A, thm:111A, thm:550A}
